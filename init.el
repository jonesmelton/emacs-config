...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ag all-the-icons neotree color-theme-sanityinc-solarized color-theme-solarized solarized-theme company tagedit smex rainbow-delimiters projectile paredit magit ido-ubiquitous exec-path-from-shell clojure-mode-extra-font-locking cider)))
 '(show-paren-mode t)
...
;; Ctrl-' for grep in directory
(global-set-key (kbd "C-'") 'ag)

;; snippets everywhere
(yas-global-mode 1)

;; Ctrl-, to trigger snippet
(global-set-key (kbd "C-,") 'yas-expand)

;; dumb jump everywhere (it doesn't work everywhere though)
(dumb-jump-mode)
